...
<head>
  ...
  <title>Cloudy Recruitment</title>
...
<div class="wrapper">
      ...
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20">
          ...
          <div class="col-md-12 latest-job">
            <div class="small-box bg-purple padding-4">
              <div class="inner">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023-2024 <a href="https://gamerriggod.blogspot.com/">Cloudy Recruitment</a>.</strong> All rights
    reserved.
    </div>
  </footer>
